import { VoteType, Favorite } from "@dactylo/db/types";
import { SelectVote } from "@dactylo/drizzle-db/models/vote";
import { Link, useFetcher } from "@remix-run/react";
import { ThumbsUp, ThumbsDown, Heart } from "lucide-react";
import { useState } from "react";
import { VideoWithVotes } from "~/routes/sign.$signId/route";
...
function VoteButtons({
	...
	count: number;
	videoId: string;
	currentVote: SelectVote | undefined;
	variant?: "default" | "compact";
