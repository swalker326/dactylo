...
export const schema = { ...terms, ...signs, ...videos, ...reports, ...favorites, ...users, ...votes, ...categories, ...videoStatuses, ...voteTypes, ...userImages, ...searches, ...searchSigns, ...requestStatuses, ...requestTypes, ...requests, ...passwords, ...sessions, ...permissions, ...roles, ...verifications, ...connections, ...termsRelations, ...signsRelations, ...videosRelations, ...reportsRelations, ...favoritesRelations, ...usersRelations, ...votesRelations, ...categoriesRelations, ...videoStatusesRelations, ...voteTypesRelations, ...userImagesRelations, ...searchesRelations, ...searchSignsRelations, ...requestStatusesRelations, ...requestTypesRelations, ...requestsRelations, ...passwordsRelations, ...sessionsRelations, ...permissionsRelations, ...rolesRelations, ...connectionsRelations, ...categoriesToSigns, ...signsToSigns, ...rolesToUsers, ...permissionsToRoles, ...categoriesToSignsRelations, ...signsToSignsRelations, ...rolesToUsersRelations, ...permissionsToRolesRelations };